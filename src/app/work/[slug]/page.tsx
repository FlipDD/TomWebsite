...
const projects: { [key: string]: Project } = {
  ...
  'marie': {
    ...
    credits: [
      { title: 'Feature Film', people: ['"A fearleess young artist, Maria Manuela refuses to confirm. Filmed over the course of four years by her closest friend, we follow her journey of self-discovery, creativity, and the ups and downs of finding her place in the world"'] },
      { title: 'Director', people: ['João Marques'] },
